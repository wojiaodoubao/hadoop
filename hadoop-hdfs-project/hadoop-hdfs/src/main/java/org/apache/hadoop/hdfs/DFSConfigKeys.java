...
public class DFSConfigKeys extends CommonConfigurationKeys {
  ...
  public static final String DFS_NAMENODE_AUDIT_LOG_REDUCE_LOGS =
      "dfs.namenode.audit.log.reduce.logs";
  public static final boolean DFS_NAMENODE_AUDIT_LOG_REDUCE_LOGS_DEFAULT =
      false;
